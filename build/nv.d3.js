...
nv.models.pie = function() {
    ...
    function chart(selection) {
        ...
        selection.each(function(data) {
            ...
            // START CUSTOM TORU INTERACTIVE REWRITE //
            if (donut && title) {
              ...
              title.forEach (function (t, i) {
                g_pie.append ("text").attr ('class', 'nv-pie-title nv-pie-title--' + i)
                var fontSize = (Math.min(availableWidth, availableHeight)) * donutRatio * 2 / (t.length + 2) - 4
                var lineHeight = fontSize + 2
                var yOffset = 15 + (title.length * lineHeight)*-0.5 + i*lineHeight

                wrap.select('.nv-pie-title--' + i)
                  .style("text-anchor", "middle")
                  .text(function (d) {
                      return t;
                  })
            ...
            // END CUSTOM TORU INTERACTIVE REWRITE //
